 ...
 */
final class MutableEntry<K, V> implements Map.Entry<K, V> {
    ...
    MutableEntry(final MutableTrieMap<K, V> map, final Map.Entry<K, V> delegate) {
        this.map = map;
     ...
     * {@inheritDoc}
     *
     * @implSpec This implementation returns the most uptodate value we have observed via this entry. It does not
     *           reflect concurrent modifications, nor does it throw {@link IllegalStateException} if the entry
     *           is removed.
     */
    @Override
    public V getValue() {
     ...
     *
     * @implSpec This implementation returns the most uptodate value we have observed via this entry. It does not
     *           reflect concurrent modifications, nor does it throw {@link IllegalStateException} if the entry is
     *           removed.
     */
    @Override
